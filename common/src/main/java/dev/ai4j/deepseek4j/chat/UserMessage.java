...
import static dev.ai4j.deepseek4j.chat.ContentType.IMAGE_URL;
import static dev.ai4j.deepseek4j.chat.ContentType.TEXT;
import static dev.ai4j.deepseek4j.chat.Role.USER;
...
public final class UserMessage implements Message {
    ...
    public static final class Builder {
        ...
        public Builder addInputAudio(InputAudio inputAudio) {
            initializeContent();
            this.content
                    .add(Content.builder().type(ContentType.AUDIO).inputAudio(inputAudio).build());
