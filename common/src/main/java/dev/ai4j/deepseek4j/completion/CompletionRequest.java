package dev.ai4j.deepseek4j.completion;
...
import static dev.ai4j.deepseek4j.completion.CompletionModel.GPT_3_5_TURBO_INSTRUCT;
...
public final class CompletionRequest {
    ...
    private boolean equalTo(CompletionRequest another) {
        return Objects.equals(model, another.model) && Objects.equals(prompt, another.prompt)
                ...
                && Objects.equals(topP, another.topP) && Objects.equals(n, another.n)
                && Objects.equals(stream, another.stream)
                && Objects.equals(streamOptions, another.streamOptions)
                && Objects.equals(logprobs, another.logprobs) && Objects.equals(echo, another.echo)
    ...
    public String toString() {
        return "CompletionRequest{" + "model=" + model + ", prompt=" + prompt + ", suffix=" + suffix
                + ", maxTokens=" + maxTokens + ", temperature=" + temperature + ", topP=" + topP
                + ", n=" + n + ", stream=" + stream + ", streamOptions=" + streamOptions
                + ", logprobs=" + logprobs + ", echo=" + echo + ", stop=" + stop
                + ", presencePenalty=" + presencePenalty + ", frequencyPenalty=" + frequencyPenalty
                + ", bestOf=" + bestOf + ", logitBias=" + logitBias + ", user=" + user + "}";
    }
