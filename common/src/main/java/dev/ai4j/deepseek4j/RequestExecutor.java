...
public class RequestExecutor<Request, Response, ResponseContent>
    ...
    RequestExecutor(Call<Response> call,
            ...
            OkHttpClient okHttpClient, String endpointUrl,
    ...
    public AsyncResponseHandling onResponse(Consumer<ResponseContent> responseHandler) {
        ...
        return new AsyncRequestExecutor<>(call, responseContentExtractor)
    ...
    public StreamingResponseHandling onPartialResponse(
        ...
        return new StreamingRequestExecutor<>(okHttpClient, endpointUrl, requestWithStreamSupplier,
                responseClass, streamEventContentExtractor, logStreamingResponses)
